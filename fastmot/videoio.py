...
class VideoIO:
    def __init__(self, size, input_uri,
        ...
        #print(self.protocol) (will print http or rtsp)
    ...
    def read_not_stream(self):
        """Reads the next video frame. In case input is not video stream from camera
    ...
    def read_is_stream(self):
        """Reads the next video frame. In case input is video stream from camera
